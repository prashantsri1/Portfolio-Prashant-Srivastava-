...
export default function HeroBanner() {
  ...
  return (
    <div className="relative w-full h-[85vh] min-h-[550px] max-h-[850px] overflow-hidden">
      {/* Background */}
      ...
      {/* Content */}
      <div className="relative z-20 h-full flex flex-col justify-end pt-24 pb-36 md:pb-44 px-6 sm:px-8 md:px-12 lg:px-16 max-w-[1400px] mx-auto">
        <motion.div
        ...
        <motion.p
          className="text-lg sm:text-xl md:text-2xl text-white/90 font-medium mb-3"
        ...
        <motion.p
          className="text-sm sm:text-base text-nf-light-gray max-w-xl mb-8 leading-relaxed"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          <button
            ...
            className="inline-flex items-center gap-3 px-8 py-3 rounded-md font-bold text-base bg-white text-nf-black hover:bg-white/85 transition-colors cursor-pointer shadow-lg"
          >
          ...
          <a
            ...
            className="inline-flex items-center gap-3 px-8 py-3 rounded-md font-bold text-base bg-nf-gray/80 text-white hover:bg-nf-gray transition-colors shadow-lg"
          >
